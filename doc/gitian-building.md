...
git clone https://github.com/airin-crypto/airin.git
cd airin
...
```bash
    ...
    From https://github.com/airin-crypto/airin
...
[airin/gitian.sigs](https://github.com/airin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
