...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/Airin-Project/Airin/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/airin-project/gitian.sigs.git
    git clone https://github.com/airin-project/airin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/airin-project/airin.git
...
- Detached signatures will then be committed to the [airin-detached-sigs](https://github.com/Airin-Project/airin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the airin.org server*.
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/airin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/Airin-Project/Airin/releases/new) with a link to the archived release notes.
